# Generated by Django 5.0.4 on 2024-07-24 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players', models.ManyToManyField(related_name='player_matches', to='main_app.tennisplayer')),
                ('winner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='winners', to='main_app.tennisplayer')),
